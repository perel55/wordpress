...
* Changed animations for blog page.
...
* Added go pro button in slider, footer and security service section in customizer.
* Updated language folder.
...
* Added comment title option in single post.
* Added comment button text option in single post.
...
* Resolved topbar search in responsive media.

= 1.0.3 =
* Added search and category for preview.
* Resolved footer background issue in customizer.
...
* Added theree and four post sidebar layout in customizer.
...
VW Security Guard WordPress Theme, Copyright 2018 VWthemes
VW Security Guard is distributed under the terms of the GNU GPL.
...
Header Image
License: CC0 1.0 Universal (CC0 1.0)
Source: https://www.pexels.com/photo/men-in-black-and-red-cade-hats-and-military-uniform-73869/

All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-security-guard/