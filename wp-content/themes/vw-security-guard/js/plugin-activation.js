jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_security_guard_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-security-guard-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-security-guard-plugin-install');
                button.addClass('button-primary vw-security-guard-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-security-guard-recommended-plugins .vw-security-guard-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-security-guard-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-security-guard-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-security-guard-recommended-plugins').css('display','none');
    });
