...
class YOP_Poll_Admin {
	...
	public function verify_update() {
        ...
        if ( $installed_version ) {
	        ...
	        if ( true === version_compare( $installed_version, '6.5.30', '<' ) ) {
		        $maintenance  = new YOP_POLL_Maintenance();
		        $maintenance->update_to_version_6_5_30();
	        }
			if ( true === version_compare( $installed_version, '6.5.31', '<' ) ) {
		        $maintenance  = new YOP_POLL_Maintenance();
		        $maintenance->update_to_version_6_5_31();
	        }
			if ( true === version_compare( $installed_version, '6.5.32', '<' ) ) {
		        $maintenance  = new YOP_POLL_Maintenance();
		        $maintenance->update_to_version_6_5_32();
	        }
			if ( true === version_compare( $installed_version, '6.5.33', '<' ) ) {
		        $maintenance  = new YOP_POLL_Maintenance();
		        $maintenance->update_to_version_6_5_33();
	        }
        }
	}
